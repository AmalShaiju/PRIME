...
namespace PRIMELibrary {
    ...
    public partial class CustomerDataSet : global::System.Data.DataSet {
        ...
        public partial class customerDataTable : global::System.Data.TypedTableBase<customerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public customerRow AddcustomerRow(string First, string Last, string Phone, string Address, string City, string Postal, string Email) {
...
namespace PRIMELibrary.CustomerDataSetTableAdapters {
    ...
    public partial class customerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [customer] ([custFirst], [custLast], [custPhone], [custAddress], [custCity], [custPostal], [custEmail]) VALUES (@First, @Last, @Phone, @Address, @City, @Postal, @Email);
SELECT id AS 'ID', custFirst AS 'First', custLast AS 'Last', custPhone AS 'Phone', custAddress AS 'Address', custCity AS 'City', custPostal AS 'Postal', custEmail AS 'Email' FROM customer WHERE (id = SCOPE_IDENTITY()) ORDER BY 'First', 'Last'";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [customer] SET [custFirst] = @First, [custLast] = @Last, [custPhone] = @Phone, [custAddress] = @Address, [custCity] = @City, [custPostal] = @Postal, [custEmail] = @Email WHERE (([ID] = @Original_ID));
SELECT id AS 'ID', custFirst AS 'First', custLast AS 'Last', custPhone AS 'Phone', custAddress AS 'Address', custCity AS 'City', custPostal AS 'Postal', custEmail AS 'Email' FROM customer WHERE (id = @id) ORDER BY 'First', 'Last'";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id AS \'ID\', custFirst AS \'First\', custLast AS \'Last\', custPhone AS \'Phone\'" +
                ", custAddress AS \'Address\', custCity AS \'City\', custPostal AS \'Postal\', custEmai" +
        ...
        public virtual int Insert(string First, string Last, string Phone, string Address, string City, string Postal, string Email) {
            if ((First == null)) {
            ...
            if ((Postal == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[5].Value = ((string)(Postal));
            }
            if ((Email == null)) {
        ...
        public virtual int Update(string First, string Last, string Phone, string Address, string City, string Postal, string Email, int Original_ID, int id) {
            if ((First == null)) {
                throw new global::System.ArgumentNullException("First");
            }
            else {
            ...
            if ((Postal == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Postal));
            }
            if ((Email == null)) {
                throw new global::System.ArgumentNullException("Email");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string First, string Last, string Phone, string Address, string City, string Postal, string Email, int Original_ID) {
            return this.Update(First, Last, Phone, Address, City, Postal, Email, Original_ID, Original_ID);
        }
    }
