        ...
        <div class="container rounded-lg">
            <div id="wrapper" class="row justify-content-sm-center">
                <div id="wrapper-inner" class="col-lg-9 rounded-lg">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label style="width:100%" class="control-label">Product Number:</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label style="width:100%" class="control-label">Date Ordered:</label>
                    ...
                    <br />
                    <br />
                    <strong style="margin-top:30px; margin-bottom:30px;"> <asp:Label ID="lblStatus" runat="server" ForeColor="Green"></asp:Label></strong>
