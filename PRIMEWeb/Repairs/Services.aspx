        ...
        <div class="container rounded-lg">
            <div id="wrapper" class="row justify-content-sm-center">
                <div id="wrapper-inner" class="rounded-lg">
                    ...
                    <div>
                     <asp:GridView ID="GridView1" runat="server" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AutoGenerateEditButton="True" CellPadding="4" CssClass="auto-style1" EmptyDataText="No Records Found" ForeColor="#333333" GridLines="None" OnRowEditing="GridView1_RowEditing" AutoGenerateDeleteButton="True" OnRowDeleting="GridView1_RowDeleting">
